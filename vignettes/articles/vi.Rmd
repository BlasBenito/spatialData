...
NDVI is one of the most widely used proxies for vegetation activity, yet its relationship with climate, soil, and human impact varies enormously across biomes. The `vi` dataset captures that variation at global scale, with ~10 000 records spanning 6 continents and 12 biomes.

---
title: "Global vegetation index: modelling NDVI across climates and biomes"
output:
...
The usage example above is only one of the many modeling approaches that can be applied to `vi`. This workflow walked through random forest regression, permutation-based importance, local variable relevance, and response curves and surfaces — all with a single global dataset. Have fun with it!

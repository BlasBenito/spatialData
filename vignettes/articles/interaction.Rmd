---
title: "Biotic interactions: modelling species dependencies with sequential SDMs"
output:
...
The resulting suitability maps and difference raster make `interaction` well suited for tutorials on biotic interactions, predictor engineering, spatial cross-validation, and divergent palette visualisation in R. Happy modelling!

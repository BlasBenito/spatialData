...
The binary integer responses are suitable for presence-absence modelling, while `community` is designed for multi-class modelling.
...
The variance inflation factor analysis below shows that the temperature predictors in `communities` are collinear with each other. Applying a multicollinearity filtering approach may be beneficial for certain modelling methods.

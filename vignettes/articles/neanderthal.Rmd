...
neanderthal_predictors
```
You can find descriptions of the palaeoclimatic predictors [here](https://www.worldclim.org/data/bioclim.html).
...
Here is the predictor ranking:

```{r}
selection$presence$preference_order[, c("response", "predictor", "score")]
```
...
Before fitting anything, let's think about the modelling choices.

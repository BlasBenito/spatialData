...
The dataset is designed to support a wide range of ecological modeling approaches.
...
This example uses `plantae` to identify predictors driving the plant richness of the World's ecoregions. 
...
The spatial random forest above demonstrates one modeling approach for `richness_species`, one of 53 response variables available in `plantae`. The dataset supports a much wider range of ecological modeling experiments, from rarity-weighted richness and beta diversity analyses to spatial cross-validation and path analysis. 

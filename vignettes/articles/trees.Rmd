...
You can download the Rmarkdown notebook used to render this article [here](https://github.com/BlasBenito/spatialData/blob/main/vignettes/articles/trees.Rmd). To download the file, use the button *Download raw file* on the upper-right hand of the `Code` panel.
